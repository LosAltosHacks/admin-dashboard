...
export async function getList() {
  ...
  response.forEach(userData => {
    ...
    document
      .getElementById("attendees-list")
      .insertBefore(
        element,
        document.getElementById("attendees-list").children[1]
      );
  });
}
...
export async function getAcceptedList() {
  ...
  response.forEach(userData => {
    ...
    document
      .getElementById("accepted-list")
      .insertBefore(
        element,
        document.getElementById("accepted-list").children[1]
      );
  });
}
...
export async function getUnacceptedList() {
  ...
  response.forEach(userData => {
    ...
    document
      .getElementById("unaccepted-list")
      .insertBefore(
        element,
        document.getElementById("unaccepted-list").children[1]
      );
  });
}
