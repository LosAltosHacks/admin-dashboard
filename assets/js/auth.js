...
function init() {
  gapi.load("auth2", function() {
    auth2 = gapi.auth2
      .init({
        client_id:
          "191344389936-gus0astcrgrq9rbp62a9q6018b61tm89.apps.googleusercontent.com",
      ...
      .then(function(auth2) {
        ...
        $("#login-page").append(
          '<div id="google-signin" class="g-signin2" data-onsuccess="onSignIn" style="display: none;"></div>'
        );
...
async function onSignIn(googleUser) {
  ...
  var result = await request("post", "/oauth/v1/login", {
